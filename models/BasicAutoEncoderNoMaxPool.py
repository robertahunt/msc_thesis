...
class Encoder(BaseModel):
    def __init__(self, imgSize, hidden_features, latent_features, in_channels):
        ...
        self.c2 = nn.Conv2d(in_channels=64, out_channels=64, kernel_size=2, stride=2)
        ...
        self.c5 = nn.Conv2d(in_channels=64, out_channels=64, kernel_size=2, stride=2)
        ...
        self.c8 = nn.Conv2d(in_channels=128, out_channels=128, kernel_size=2, stride=2)
...
class BasicAutoEncoderNoMaxPool(BaseModel):
    def __init__(self, imgSize, hidden_features, latent_features, in_channels=3):
        super(BasicAutoEncoderNoMaxPool, self).__init__()
