...
from .modelUtils import calc_size_after_mp, calc_size_after_conv, make_random_GMM
...
class VariationalAutoEncoderGMM(BaseModel):
    def __init__(self, imgSize, hidden_features, latent_features, num_samples, cuda, in_channels, n_gaussians, min_mu, max_mu, sigma):
        ...
        self.g = make_random_GMM(latent_features, n_gaussians, sigma, min_mu, max_mu, cuda)
    ...
    def _plot_tsne(self, ax, z_plot, y_plot, classes, colors):
        ...
        z_plot = np.append(z_plot,g_mus.squeeze().cpu().numpy(), axis=0)
